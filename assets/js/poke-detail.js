...
const urlLocalizar = new URLSearchParams(window.location.search)
const name = urlLocalizar.get("name")
...
function convertPokemonToHtml(pokemon) {
    ...
    pokemonDesc.innerHTML = `
        <div class="pokemon ${type} pokemon-detail">
            <a href="index.html">
            ...
            <img src="${pokemon.sprites.other.dream_world.front_default}" alt="Bulbasaur" class="img">
